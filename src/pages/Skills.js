...
function Skills() {
    ...
    return (
        <div className="Skills">
            ...
            Feel free to explore each skill, and if you're curious about my experience or projects related to a particular skill, just <u>click on it for more details</u>.
            </p>
